...
import com.brauner.advent.day2.ChecksumCalculator;
...
public class ChecksumCalculatorTest {
    ...
    @Test
    public void calculateDifferenceChecksum() throws Exception {
        ...
        System.out.println(calculator.calculateDifferenceChecksum(input));
    }

    @Test
    public void evenlyTest() {
        String inputTest = "5 9 2 8\n" +
                "9 4 7 3\n" +
                "3 8 6 5";
        ...
        String input = "790\t99\t345\t1080\t32\t143\t1085\t984\t553\t98\t123\t97\t197\t886\t125\t947\n" +
                ...
                "3928\t107\t3406\t123\t2111\t2749\t223\t125\t134\t146\t3875\t1357\t508\t1534\t4002\t4417";
        ChecksumCalculator calculator = new ChecksumCalculator();
        System.out.println(calculator.evenlyDivisible(input));
    }
